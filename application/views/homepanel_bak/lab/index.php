                ...
                <?php foreach ($articles as $article) { ?>
                    <div class="contain_left_content_line">
                        ...
                        <div class="contain_left_content_line_right" >
                            ...
                            <a href="<?php echo site_url('homepanel/lab/detail?id=') . $article['id']; ?>">
    ...
    <div class="contain_right">
        ...
        <div class="contain_right_content">
            <ol class="contain_right_content_ol">
                ...
                <li class="contain_right_content_ol_li"><a href="<?php echo site_url('homepanel/lab/detail?id=') . $hot['id']; ?>"><?php echo $hot['title']; ?></a></li>
                <?php }
                } else { ?>
    ...
    layui.use(['form','layer','jquery', 'laypage'],function() {
        ...
        laypage.render({
            ...
            ,jump: function(obj, first){
                ...
                //首次不执行
                if(!first){
                    window.location.href = '/homepanel/lab/index?page=' + obj.curr;
                }
            }
        });
