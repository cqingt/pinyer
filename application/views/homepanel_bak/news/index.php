                ...
                <?php foreach ($articles as $article) { ?>
                    <div class="contain_left_content_line">
                        <div class="contain_left_content_line_left">
                            <img src="<?php echo $article['image'] ?  : $default; ?>" width="150" height="150px" alt="">
                        </div>
                        <div class="contain_left_content_line_right" >
                            <div class="contain_left_content_line_right_top" >
                                <div><a href="<?php echo site_url('homepanel/news/detail?id=') . $article['id']; ?>"><?php echo $article['title']; ?></a></div>
                            </div>
                            <div class="contain_left_content_line_right_bottom">
                                <?php echo $article['description']; ?>
                            </div>
                            <a href="<?php echo site_url('homepanel/news/detail?id=') . $article['id']; ?>">
    ...
    <div class="contain_right">
        ...
        <div class="contain_right_content">
            <ol class="contain_right_content_ol">
                ...
                <li class="contain_right_content_ol_li"><a href="<?php echo site_url('homepanel/news/detail?id=') . $hot['id']; ?>"><?php echo $hot['title']; ?></a></li>
                <?php }
                } else { ?>
    ...
    layui.use(['form','layer','jquery', 'laypage'],function() {
        ...
        laypage.render({
            ...
            ,jump: function(obj, first){
                ...
                //首次不执行
                if(!first){
                    window.location.href = '/homepanel/news/index?page=' + obj.curr;
                }
            }
        });
