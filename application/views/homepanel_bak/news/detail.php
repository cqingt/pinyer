    ...
    <div class="con_right">
        ...
        <?php if (! empty($recommends)) { ?>
            <?php foreach ($recommends as $recommend) { ?>
                <div class="con_right_detail" data-href="<?php echo site_url('/homepanel/news/detail?id=') . $recommend['id']; ?>">
                ...
                success: function (result) {
                    if (result.code == 200) {
                        ...
                        for (var i = 0, len = data.length; i < len; i++) {
                            html += '<div class="con_right_detail" data-href="/homepanel/news/detail?id=' + data[i].id + '">\n'+
