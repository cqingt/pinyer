...
<head>
    ...
    <script>
        window.UMEDITOR_HOME_URL = "/static/uediter/"
    </script>
</head>
	...
	<div class="layui-col-md9 layui-col-xs12">
		<div class="layui-row layui-col-space10">
			<div class="layui-col-md9 layui-col-xs7">
                <input type="hidden" name="id" value="<?php echo $article['id']; ?>" class="key">
				<div class="layui-form-item magt3">
					<label class="layui-form-label">文章标题</label>
					<div class="layui-input-block">
						<input type="text" class="layui-input title" name="title" lay-verify="title" value="<?php echo $article['title']; ?>">
					</div>
				</div>
                <div class="layui-form-item">
                    <label class="layui-form-label">关键词</label>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input keywords" name="keywords" lay-verify="keywords" value="<?php echo $article['keywords']; ?>">
                    </div>
                </div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea placeholder="请输入描述" name="description" class="layui-textarea description" lay-verify="description"><?php echo $article['description']; ?></textarea>
					</div>
				</div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入文章摘要" name="abstract" class="layui-textarea abstract" lay-verify="abstract"><?php echo $article['abstract']; ?></textarea>
                    </div>
                </div>
			</div>
			<div class="layui-col-md3 layui-col-xs5">
				<div class="layui-upload-list thumbBox mag0 magt3">
					<img class="layui-upload-img thumbImg" src="<?php echo $article['image'] ? : ''; ?>">
                    <input type="hidden" name="image" value="<?php echo $article['image']; ?>" id="thumb">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
...
<!--			</div>-->
		...
		<div class="layui-form-item">
			<div class="layui-form-item newsTop">
				...
				<div class="layui-input-inline">
					<input type="number" name="position" class="layui-input position" value="<?php echo $article['position']; ?>">
				</div>
        ...
        <div class="layui-form-item">
            <div class="layui-form-item newsTop">
                ...
                <div class="layui-input-inline">
                    <input type="number" name="likes" class="layui-input position" value="<?php echo $article['likes']; ?>">
                </div>
            </div>
        </div>
		...
		<div class="layui-form-item">
			<div class="layui-form-item newsTop">
				...
				<div class="layui-input-block">
					<input type="checkbox" name="is_hot" lay-skin="switch" lay-text="是|否" class="is_hot" <?php echo $article['is_hot']  ? 'checked="checked"' : ''; ?>">
				</div>
			</div>
		</div>
		...
		<div class="layui-form-item">
			<div class="layui-form-item newsTop">
				...
				<div class="layui-input-block">
					<input type="checkbox" name="recommend" lay-skin="switch" lay-text="是|否" class="recommend" <?php echo $article['recommend']  ? 'checked="checked"' : ''; ?>">
				</div>
			</div>
		</div>
        ...
        <div class="layui-form-item">
            ...
            <div class="">
                <a class="layui-btn layui-btn-sm" lay-filter="addNews" lay-submit><i class="layui-icon">&#xe609;</i>保存修改</a>
